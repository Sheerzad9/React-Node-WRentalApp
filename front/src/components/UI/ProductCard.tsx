import { Product } from "../../assets/dummy-data";
    ...
    <>
      <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow transition-all hover:shadow-xl hover:skew-y-1 duration-300 relative sm:w-auto">
            ...
            <div className="flex flex-col">
              <img
                ...
                src={
                  ...
                  "images/avatars/user-profile-default.svg"
                }
              />
              <div className="flex">
                <Star
        ...
        <div className="flex flex-col justify-center gap-5">
          ...
          <a className="inline-block w-2/4 sm:w-2/5 py-3 sm:py-4 text-center text-white rounded-full bg-button-primary mr-4 mb-4 font-bold tracking-wide text-xs sm:text-sm self-end cursor-pointer shadow-md transition-all duration-300 ease-in-out hover:bg-[#fb923c] hover:shadow-lg hover:w-3/4 sm:hover:w-3/5">
            Vuokraa nyt &rarr;
          </a>
        </div>
      </div>
